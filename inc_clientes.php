...
require_once "interface_grau.php";
require_once "interface_cobranca.php";
require_once "class_fisica.php";
require_once "class_juridica.php";
require_once "class_especial.php";


$cliente = array();

$novo_cliente = new fisica();
